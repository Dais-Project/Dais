...
class ServiceStatusCode(StrEnum):
    ...
    def status_code_map(code: ServiceStatusCode) -> int:
        ...
        return ({
            ...
            ServiceStatusCode.UNAUTHENTICATED: status.HTTP_401_UNAUTHORIZED,
            ServiceStatusCode.INTERNAL: status.HTTP_500_INTERNAL_SERVER_ERROR,
...
class ServiceErrorCode(StrEnum):
    ...
    TASK_RESOURCE_ACCESS_INVALID = "TASK_RESOURCE_ACCESS_INVALID"
...
class ServiceError(Exception):
    def __init__(self, status_code: ServiceStatusCode, error_code: ServiceErrorCode, message: str):
...
class NotFoundError(ServiceError):
    def __init__(self, error_code: ServiceErrorCode, resource_type: str, identifier: int | str):
...
class InternalError(ServiceError):
    def __init__(self, error_code: ServiceErrorCode, message: str):
        super().__init__(ServiceStatusCode.INTERNAL, error_code, message)

...
class TestReadFileBatch:
    def test_read_single_file(self, built_in_toolset_context, temp_workspace, sample_text_file):
    ...
    def test_read_multiple_files(self, built_in_toolset_context, temp_workspace, multiple_files):
        tool = FileSystemToolset(built_in_toolset_context)
    ...
    def test_read_batch_with_nonexistent_file(self, built_in_toolset_context, temp_workspace, sample_text_file):
        filename, content = sample_text_file
        tool = FileSystemToolset(built_in_toolset_context)
    ...
    def test_read_batch_with_line_numbers(self, built_in_toolset_context, temp_workspace, multiple_files):
        tool = FileSystemToolset(built_in_toolset_context)
        filenames = list(multiple_files.keys())

...
async def get_schedules(
    ...
    return await service.get_schedules_page(workspace_id, query)
...
async def get_all_run_records(service: RunRecordServiceDep):
    return await service.get_all_run_records_page()
...
async def get_schedule_records(service: RunRecordServiceDep, schedule_id: int):
    return await service.get_run_records_page(schedule_id)
...
async def update_schedule(
    ...
    return await service.update_schedule(schedule_id, body)
...
async def get_run_record(service: RunRecordServiceDep, run_record_id: int):
    return await service.get_run_record_by_id(run_record_id)
...
async def delete_run_record(service: RunRecordServiceDep, run_record_id: int):
    await service.delete_run_record(run_record_id)

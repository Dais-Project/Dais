...
function openSkillCreateTab() {
  ...
  addTab({
    type: "skill",
    title: i18n.t("tab.create_title", { ns: SIDEBAR_SKILL_NAMESPACE }),
    icon: "scroll-text",
  ...
  const uploadArchiveMutation = useUploadArchive({
    mutation: {
      async onSuccess() {
        ...
        toast.success(t("toast.upload_success_title"), {
          description: t("toast.upload_success_description"),
        });
      },
    },
  });
        ...
        <div className="flex h-full flex-col">
          ...
          <SideBarHeader title={t("header.title")} actionsClass="flex-1 ml-4">
            ...
            <ButtonGroup>
              ...
              <SideBarHeaderAction
                Icon={FileUpIcon}
                tooltip={t("header.upload_tooltip")}

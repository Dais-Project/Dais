...
async def get_provider(provider_id: int, db_session: DbSessionDep):
    return await ProviderService(db_session).get_provider_by_id(provider_id)
...
async def create_provider(body: provider_schemas.ProviderCreate, db_session: DbSessionDep):
    return await ProviderService(db_session).create_provider(body)
...
async def update_provider(
    ...
    return await ProviderService(db_session).update_provider(provider_id, body)
